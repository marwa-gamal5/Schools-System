...
import Settings from './pages/Administration/Settingss/Settings';
      ...
      <BrowserRouter>
        <Routes>
          ...
          />
            ...
            <Route
                exact
                path="/academics/newacadmicyears/"
                element={
                    <>
                        <Navbarr />
                        <SideBar />
            ...
            <Route
                exact
                path="/academics/viewacadmicyear/:idd"
                element={
                    <>
                        <Navbarr />
                        <SideBar />
            ...
            <Route
                exact
                path="/academics/academicyearSemester"
                element={
                    <>
                        <Navbarr />
                        <SideBar />
        ...
        <Route
          ...
          />
                 <Route
            exact
            path="/Administration/AdmissionRegistration/ManageStage"
            element={
              <>
                <Navbarr />
                <SideBar />
          ...
          />
            <Route
                exact
                path="/Administration/AdmissionRegistration/ApplicantRegistrationSetting/ManageGrades"
                element={
                    <>
                        <Navbarr />
                        <SideBar />
            ...
            <Route
                exact
                path="/Administration/AdmissionRegistration/ApplicantRegistrationSetting/ManageGrades/AddGRade"
                element={
                    <>
                        <Navbarr />
                        <SideBar />
