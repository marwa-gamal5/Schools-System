...
function SideBar() {
  ...
  const links = [
    ...
    { path: "/Sons", name: "Sons", icon: Vector3 },
    { path: "/Sms", name: "Sms", icon: Vector4 },
    { path: "/Fees", name: "Fees", icon: Vector5 },
    { path: "/News_Events", name: "News & Events", icon: Vector6 },
    { path: "/e-services", name: "E-Services", icon: Vector7 },
    // Update these paths when they're available
    { path: "/Memos", name: "Memos", icon: Vector8 },
    { path: "/Important Links", name: "Important Links", icon: Vector9 },
  ];
